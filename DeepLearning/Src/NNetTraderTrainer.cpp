...
namespace jv
{
	...
	{
		auto ptr = reinterpret_cast<NNetTraderTrainer*>(info.userPtr);
	...
	void NNTraderReset(const bt::STBTBotInfo& info)
	{
		...
		*ptr = NNetTraderTrainer::Create(*arena, *tempArena, nnetInfo);
	...
	void NNetTraderTrainer::Destroy(Arena& arena, NNetTraderTrainer& trader)
	{
